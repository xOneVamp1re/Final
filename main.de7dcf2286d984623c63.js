  ...
  showMoreButtons.forEach(function (item) {
    item.addEventListener('click', function (event) {
      ...
      if (buttonId === 'about-us') {
        let elem = document.querySelector('.text-wrapper[data-show-more="' + buttonId + '"]');
        ...
        let elem = document.querySelector('.swiper-wrapper[data-show-more="' + buttonId + '"]');
        if (item.classList.contains('button-show-more--active')) {
...
/******/ })()
;
//# sourceMappingURL=main.de7dcf2286d984623c63.js.map